load("1d_gauss_n10_50_3001points_ests_NEWER_11.RData")
...
yaglom1_dist
yaglom1_kriging <- gauss_kriging(vals, seqRF, upperX, randomPoints, dists_withinList, spatDf, spatGrid, z, zOrig, zeroIdx)
yaglom1_kriging
yaglom1_kriging_gstat <- gauss_kriging_gstat(vals, lags=xNew[1:256], xNew, 256, randomPoints, spatDf, spatGrid, zOrig)
...
yaglom2_dist
yaglom2_kriging <- gauss_kriging(vals2, seqRF, upperX, randomPoints, dists_withinList, spatDf, spatGrid, z, zOrig, zeroIdx)
yaglom2_kriging
yaglom2_kriging_gstat <- gauss_kriging_gstat(vals2, lags=xNew[1:256], xNew, 256, randomPoints, spatDf, spatGrid, zOrig)
...
yaglom3_dist
yaglom3_kriging <- gauss_kriging(vals3, seqRF, upperX, randomPoints, dists_withinList, spatDf, spatGrid, z, zOrig, zeroIdx)
yaglom3_kriging
yaglom3_kriging_gstat <- gauss_kriging_gstat(vals3, lags=xNew[1:256], xNew, 256, randomPoints, spatDf, spatGrid, zOrig)
...
hall_dist
hall_kriging <- gauss_kriging(vals_hall_2_idct, seqRF, upperX, randomPoints, dists_withinList, spatDf, spatGrid, z, zOrig, zeroIdx)
hall_kriging
hall_kriging_gstat <- gauss_kriging_gstat(vals_hall_2_idct, lags=xNew[1:256], xNew, 256, randomPoints, spatDf, spatGrid, zOrig)
hall_kriging_gstat
...
rob_dist
rob_kriging <- gauss_kriging(rob_est_vals, seqRF, upperX, randomPoints, dists_withinList, spatDf, spatGrid, z, zOrig, zeroIdx)
rob_kriging
rob_kriging_gstat <- gauss_kriging_gstat(rob_est_vals, lags=xNew[1:256], xNew, 256, randomPoints, spatDf, spatGrid, zOrig)
rob_kriging_gstat
...
tapered_dist
tapered_kriging <- gauss_kriging(tapered, seqRF, upperX, randomPoints, dists_withinList, spatDf, spatGrid, z, zOrig, zeroIdx)
tapered_kriging
tapered_kriging_gstat <- gauss_kriging_gstat(tapered, lags=xNew[1:256], xNew, 256, randomPoints, spatDf, spatGrid, zOrig)
...
splines_dist
splines_kriging <- gauss_kriging(splineVals, seqRF, upperX, randomPoints, dists_withinList, spatDf, spatGrid, z, zOrig, zeroIdx)
splines_kriging
splines_kriging_gstat <- gauss_kriging_gstat(splineVals, lags=xNew[1:256], xNew, 256, randomPoints, spatDf, spatGrid, zOrig)
